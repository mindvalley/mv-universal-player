...
const previewModeTexts = {
  membership: {
    ...
    subtext:
      'Access 500+ guided meditations to elevate your mind and spirit with a Mindvalley Membership.'
  },
  'not-for-sale': {
...
<template>
  ...
  >
    <div class="mb-6 flex items-center">
      <div
        class="h-10 w-10 rounded-full mr-3 bg-white bg-opacity-10 flex items-center justify-center"
      >
        <svg v-svg symbol="lock-outlined" size="16" color="#fff"></svg>
      </div>
