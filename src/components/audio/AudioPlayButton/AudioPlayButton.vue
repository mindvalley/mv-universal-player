<template>
  <button
    @click="togglePlay"
    class="group relative mx-8 flex h-16 w-16 items-center justify-center rounded-full bg-cool-grey-300 text-black duration-200 ease-in hover:scale-105 hover:bg-white"
  >
